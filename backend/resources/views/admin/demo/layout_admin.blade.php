...
<head>
    ...
    <script src="{{ asset('js/datepickerCitizen.js') }}" defer></script>
...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="#" > <img src="{{asset('images/system/logo.png')}}" alt="brand logo" class="w-25"> </a>
        ...
        <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
            <li class="nav-item dropdown">
                ...
                @if(Auth::check())
                    {{ ucwords(Auth::user()->users_fname) .' '. ucwords(substr(Auth::user()->users_mname, 0, 1) ).'. ' . ucwords(Auth::user()->users_lname)}}
                @endif
                </a>
    ...
    <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            ...
            <div class="sb-sidenav-footer">
                ...
                {{Auth::user()->type->types_description }}
            </div>
        </nav>
    </div>
