...
@section('title', ' Citizen Registration Form')
...
<section id="IndividualRegister">
    <div class="container">
        <div class="row">
            <div class="col-xl-12 text-center">
                <h3 class="mt-3">COVID-19 Contact Tracing Libmanan</h3>
                <h5 class="form_sub_title_registration" id="formTitle">Step 1 of 3 : Registration</h5>
            </div>
        </div>

        <form method="POST" enctype="multipart/form-data" id="citizen-new" action="javascript:void(0)" >
            @csrf
            <div class="row justify-content-center mt-2 mb-5" >

                <div class="col-xl-6 col-lg-8 col-md-10 col-sm-12 col-11 form-columns">

                    <div class="row">
                        <div class="col-xl-12">
                        
                        @if (session()->has('hasData'))
                        <div class="alert alert-danger">
                            <strong>Error! </strong>{{session()->get('hasData')}}
                            <a href="/citizen/i-card">Click here if you want to download again your ID</a>
                        </div>
                        @endif
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="photo" required name="imgProfile" accept="image/x-png,image/jpeg" >
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <label for="municipality" class='label-municipality'>City / Municipality</label>
                        ...
                        <div class="form-group">
                            ...
                            <label for="barangay" class="label-barangay">Barangay</label>
                        ...
                        <div class="form-group" id="zone_div_select">
                            ...
                            <label for="zone" class="label-zone">Zone</label>
                        ...
                        <div class="form-group">
                            ...
                            <label for="details" class="details-reg label-bldg ">House/Unit/Flr #, Bldg Name, Blk or Lot #</label>
                    ...
                    <div class="row mt-4" id="currentAddress">
                        <div class="col-xl-12">
                            ...
                            <div class="form-group">
                                ...
                                <label for="municipality_current" class="label-curMunicipality">City / Municipality</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="barangay_current" class="label-curBarangay">Barangay</label>
                            ...
                            <div class="form-group" id="zone_div_select_current">
                                ...
                                <label for="zone_current" class="label-curZone">Zone</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="details_current" class="details-reg label-curDetail">House/Unit/Flr #, Bldg Name, Blk or Lot #</label>
                                <small id="suffixHelp" class="form-text text-muted">Optional if you don't have.</small>
                            </div>
                    ...
                    <div class="custom-control custom-checkbox mb-3">
                        ...
                        <label class="custom-control-label" for="chkTerms">I agree to Libmanan Contact Tracing's <a href="#">Terms of Use and Privacy Policy</a></label>
                    </div>
