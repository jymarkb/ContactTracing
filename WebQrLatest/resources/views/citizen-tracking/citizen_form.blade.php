...
@section('js-import')
<script src="{{ asset('js/citizen/tracking.js') }}"></script>
@endsection
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-11 col-12 track-columns  mt-3 mb-5">
                ...
                <p>Start tracking your check in, enter your mobile number below used during the registration.</p>
                ...
                <form method="POST" enctype="multipart/form-data" id="id_download" action="javascript:void(0)">
                    ...
                    <div class="form-group">
                        <input type="number" class="form-control form-control-lg" id="number" name="number" max="11" placeholder="e.g (09514292787)">
