...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>iSave - Libmanan Contact Tracing - @yield('title')</title>
                ...
                <button class="navbar-toggler collapsed" type="button" data-toggle="collapse" data-target="#collapsibleNavbar"><span class="small navbar-toggler-icon "></span></button>
                    <div class="collapse navbar-collapse " id="collapsibleNavbar">
                        ...
                        <ul class="navbar-nav justify-content-end">
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('citizen/map') ? 'active' : '' }}" href="/citizen/map" id="nav-symptoms"> Covid-19</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('citizen/tracking*') ? 'active' : '' }}" href="/citizen/tracking" id="nav-symptoms"> Tracking</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('citizen/i-card*') ? 'active' : '' }}" href="/citizen/i-card" id="nav-symptoms"> I-Card</a>
                            </li>
                        </ul>
